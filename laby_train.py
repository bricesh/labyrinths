...
# Load file
with open('labys/saved_games_small.txt', 'r') as f:
    paths = [line.replace('\n', '').split(',') for line in f]
...
training_features["direction"].value_counts() # Could improve the class balance...
...
pickle.dump(rf_clf, open( "rf_clf.p", "wb" ))
...
training_features = training_data[["x", "y", "up", "down", "left", "right", "direction"]]
training_features["pre_x"] = training_features["x"].shift(1)
training_features["pre_y"] = training_features["y"].shift(1)
training_features["pre_direction"] = training_features["direction"].shift(1)
...
training_features.loc[training_features["x"]==0,"pre_direction"]=training_features[training_features["x"]==0]["direction"]
training_features = training_features[["up", "down", "left", "right", "pre_direction"]]


print training_action["direction"].value_counts() # Could improve the class balance...
...
pickle.dump(rf_clf, open( "rf_clf_with_predir.p", "wb" ))